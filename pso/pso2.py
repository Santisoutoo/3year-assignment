...
line1, = ax.plot([], [], 'o', color='#d2eeff', markersize=3, markerfacecolor='#d2eeff', lw=0.1,
                 markeredgecolor='#0077BE')  # line for Earth
...
anim.save("PSO2.gif", dpi=120, writer="imagemagick")
